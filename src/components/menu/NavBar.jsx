...
const NavBar = () => {
  ...
  const closeMenuClass =
    'absolute top-10 flex w-full items-center bg-white px-8 text-black py-4 justify-between lg:justify-start lg:py-0 lg:bg-transparent';
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex lg:gap-4 lg:text-white" id="navLinks">
        <NavLink text="home" />
        <NavLink text="shop" />
        <NavLink text="about" />
