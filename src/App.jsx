    ...
    <div>
      ...
      <header className="grid grid-cols-3 grid-rows-[10fr_1.5fr_10fr] lg:grid-cols-7 lg:grid-rows-[10fr_1.5fr]">
        <img
          src={ImgHero1}
          alt=""
          className="col-start-1 col-end-4 row-start-1 row-end-3 h-full w-full lg:col-start-1 lg:col-end-5 lg:row-span-2 lg:row-start-1 lg:row-end-3"
        />
        <article className="col-start-1 col-end-4 row-start-3 row-end-4 flex flex-col items-start justify-center p-8 lg:col-start-5 lg:col-end-8 lg:row-start-1 lg:row-end-2 lg:px-24">
